...
// Redirect-based sign-in — works on all devices and browsers including mobile.
// The page reloads after Google auth; onAuthStateChanged picks up the user automatically.
export async function signInWithGoogle() {
  await signInWithRedirect(auth, googleProvider);
}

// Call this once on app mount to handle the return from Google's OAuth redirect.
export async function handleAuthRedirect() {
  try {
    ...
    // Redirect result errors are silent — user just won't be signed in
  }
}
